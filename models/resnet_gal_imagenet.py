...
def resnet56_gal(n_classes, **kwargs):
    return ResNet(ResBasicBlock, 56, num_classes=n_classes, **kwargs)

def resnet56_sparse(n_classes, **kwargs):
    return ResNet(SparseResBasicBlock, 56, num_classes=n_classes,  **kwargs)

def resnet110_gal(n_classes, **kwargs):
    return ResNet(ResBasicBlock, 110, num_classes=n_classes,  **kwargs)
