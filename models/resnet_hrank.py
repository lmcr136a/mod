...
class ResBasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, compress_rate=[0., 0.]):
...
def resnet56_hrank(num_classes, compress_rate=None):
...
def resnet110_hrank(num_classes, compress_rate=None):
    cov_cfg = [(3 * i + 2) for i in range(18 * 3 * 2 + 1)]
    return ResNet(ResBasicBlock, 110, cov_cfg, compress_rate=compress_rate, num_classes=num_classes)
